...
export async function POST(request: Request) {
  ...
  const isValid = skipSignatureValidation
    ? true
    : signatureUrls.some(url =>
  ...
  console.log("SMS webhook inbound", {
    from: from || null,
    body: incomingBody,
